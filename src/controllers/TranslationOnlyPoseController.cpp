#include "TranslationOnlyPoseController.h"
#include <Eigen/Dense>
#include <iostream>
...
TranslationOnlyPoseController::TranslationOnlyPoseController(DQ_kinematics robot, MatrixXd translation_feedback_gain, MatrixXd rotation_feedback_gain, double translation_damping, double rotation_damping) : DQ_controller()
{
...
VectorXd TranslationOnlyPoseController::getNewJointPositions( const DQ reference, const VectorXd thetas)
{
...
VectorXd TranslationOnlyPoseController::getNewJointVelocities( const DQ reference, const VectorXd thetas)
{
