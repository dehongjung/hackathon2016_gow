#ifndef DQTRANSLATIONONLYPOSECONTROLLER_H
#define DQTRANSLATIONONLYPOSECONTROLLER_H
...
class TranslationOnlyPoseController : public DQ_controller
{
...
public: //methods
    TranslationOnlyPoseController(DQ_kinematics robot, MatrixXd translation_feedback_gain, MatrixXd rotation_feedback_gain, double translation_damping, double rotation_damping);
    ~TranslationOnlyPoseController(){};
